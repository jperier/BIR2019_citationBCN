...
class BiattentiveClassificationNetwork(Model):
    ...
    def get_metrics(self, reset: bool = False) -> Dict[str, float]:
        res = {metric_name: metric.get_metric(reset) for metric_name, metric in self.metrics.items()}
        res["macro-f"]=(res['f1_0']+res['f1_1']+res['f1_2']+res['f1_3']+res['f1_4']+res['f1_5'])/6
        return res
